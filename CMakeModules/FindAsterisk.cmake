...
if(NOT HAVE_PBX_STASIS_H)
	...
	set(PBX_EVENT_SERIALIZER lib/ast_event_message_serializer.c)
	MESSAGE("Dealing with Asterisk <= Version 11")
else(NOT HAVE_PBX_STASIS_H)
	set(HAVE_PBX_VERSION_12 1)
	set(PBX_EVENT_SERIALIZER lib/ast_stasis_message_serializer.c)
	MESSAGE("Dealing with Asterisk >= Version 12")
endif()
